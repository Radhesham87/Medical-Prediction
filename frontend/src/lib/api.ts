...
export type ModuleKey = "aiims" | "all-india" | "deemed" | "veterinary" | "mbbs-other-state" | "bams-other-state";
...
export const api = {
  ...
  setUserModules: (
    id: number,
    modules: { aiims: boolean; all_india: boolean; maharashtra: boolean; deemed: boolean; veterinary: boolean; mbbs_other_state: boolean; bams_other_state: boolean }
  ) =>
