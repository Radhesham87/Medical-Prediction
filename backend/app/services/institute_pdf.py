...
# Unicode (Latin + Devanagari) font so mixed English/Marathi institute names
# render correctly instead of showing blank boxes. See pdf_generator.py for
    ...
    *,
    ...
    if module == "veterinary":
        ...
        for i, r in enumerate(vet_rows, start=1):
            data.append([
                str(i),
                Paragraph(_pdf_safe(str(r["institute_name"])).title(), cell),
    ...
    data = [headers]
    for r in results:
        row = [str(r["sr_no"]), Paragraph(_pdf_safe(str(r["institute_name"])).title(), cell)]
        if show_degree:
...
def _build_branded_institute_pdf(
    *,
    ...
    cell_s = ParagraphStyle("cell", fontName=FONT_REGULAR, fontSize=8, textColor=NAVY, leading=10)
    ...
    for i, r in enumerate(ordered, start=1):
        ...
        data.append([
            [Paragraph(_pdf_safe(str(r.get("institute_name", ""))).title(), cname),
            ...
            Paragraph(band, ParagraphStyle(
                "bnd", fontName=FONT_BOLD, fontSize=8,
